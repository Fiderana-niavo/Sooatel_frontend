                ...
                >
                  {editingId === item.idEvent ? (
                    ...
                    <div className="flex-1 font-semibold text-foreground text-sm">
                      {item.label || item.eventName || item.roomNumber || item.ref || item.idEvent}
                    </div>
                  )}
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    {editingId === item.idEvent ? (
                      ...
                      <>
                        ...
                        <Button size="icon" variant="ghost" onClick={() => onDelete(item.idEvent)} className="opacity-0 group-hover:opacity-100 text-destructive">
