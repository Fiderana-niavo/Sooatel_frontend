...
import { Box, Edit, Trash2, Plus, X, Check } from "lucide-react";
...
export function ItemsModal({ isOpen, onClose, data, onAdd, onEdit, onDelete }: ItemsModalProps) {
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <DialogDescription className="text-muted-foreground mt-1 text-sm">
                  Gérez le stock et les articles.
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
                ...
                >
                  {editingId === item.idItem ? (
                    ...
                    <div className="flex-1 font-semibold text-foreground text-sm">
                      {item.label || item.eventName || item.roomNumber || item.ref || item.idItem}
                    </div>
                  )}
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    {editingId === item.idItem ? (
                      ...
                      <>
                        ...
                        <Button size="icon" variant="ghost" onClick={() => onDelete(item.idItem)} className="opacity-0 group-hover:opacity-100 text-destructive">
