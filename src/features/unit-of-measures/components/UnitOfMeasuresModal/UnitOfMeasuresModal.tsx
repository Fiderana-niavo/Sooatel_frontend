...
import { Scale, Edit, Trash2, Plus, X, Check } from "lucide-react";
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <DialogTitle className="text-2xl font-bold tracking-tight text-secondary">
                  Gestion: Unités de mesure
                </DialogTitle>
                <DialogDescription className="text-muted-foreground mt-1 text-sm">
                  Gérez les unités (kg, litre, etc.).
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
                ...
                >
                  {editingId === item.idUnit ? (
                    ...
                    <div className="flex-1 font-semibold text-foreground text-sm">
                      {item.label || item.eventName || item.roomNumber || item.ref || item.idUnit}
                    </div>
                  )}
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    {editingId === item.idUnit ? (
                      ...
                      <>
                        ...
                        <Button size="icon" variant="ghost" onClick={() => onDelete(item.idUnit)} className="opacity-0 group-hover:opacity-100 text-destructive">
