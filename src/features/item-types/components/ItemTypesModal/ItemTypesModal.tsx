...
import { Layers, Edit, Trash2, Plus, X, Check } from "lucide-react";
...
export function ItemTypesModal({ isOpen, onClose, data, onAdd, onEdit, onDelete }: ItemTypesModalProps) {
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <DialogDescription className="text-muted-foreground mt-1 text-sm">
                  Catégorisez les articles du stock.
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
                ...
                >
                  {editingId === item.idProductType ? (
                    ...
                    <div className="flex-1 font-semibold text-foreground text-sm">
                      {item.label || item.eventName || item.roomNumber || item.ref || item.idProductType}
                    </div>
                  )}
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    {editingId === item.idProductType ? (
                      ...
                      <>
                        ...
                        <Button size="icon" variant="ghost" onClick={() => onDelete(item.idProductType)} className="opacity-0 group-hover:opacity-100 text-destructive">
