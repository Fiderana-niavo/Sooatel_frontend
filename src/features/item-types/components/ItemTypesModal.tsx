          ...
          <div className="bg-muted/10 p-5 rounded-2xl border border-border/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
              <div className="space-y-1.5">
                ...
                <Input placeholder="Ex: Boisson" value={newLabel} onChange={(e) => setNewLabel(e.target.value)} className="bg-background" />
              </div>
              <div className="space-y-1.5">
                  ...
                  {editingId === item.idProductType ? (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        ...
                        <Button size="icon" variant="ghost" onClick={() => onDelete(item.idProductType)} className="opacity-0 group-hover:opacity-100 text-destructive"><Trash2 className="size-4" /></Button>
                      </div>
                    </div>
                  )}
                </div>
