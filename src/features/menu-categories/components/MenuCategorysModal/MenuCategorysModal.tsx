...
import { List, Edit, Trash2, Plus, X, Check } from "lucide-react";
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <DialogTitle className="text-2xl font-bold tracking-tight text-secondary">
                  Gestion: Catégories de Menu
                </DialogTitle>
                <DialogDescription className="text-muted-foreground mt-1 text-sm">
                  Gérez les catégories du menu (Entrées, Plats...).
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
                ...
                >
                  {editingId === item.idCategory ? (
                    ...
                    <div className="flex-1 font-semibold text-foreground text-sm">
                      {item.label || item.eventName || item.roomNumber || item.ref || item.idCategory}
                    </div>
                  )}
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    {editingId === item.idCategory ? (
                      ...
                      <>
                        ...
                        <Button size="icon" variant="ghost" onClick={() => onDelete(item.idCategory)} className="opacity-0 group-hover:opacity-100 text-destructive">
